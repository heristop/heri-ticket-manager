 ...
 * @method TopicQuery orderByLabel($order = Criteria::ASC) Order by the label column
 *
 * @method TopicQuery groupById() Group by the id column
 * @method TopicQuery groupByLabel() Group by the label column
 *
 ...
 *
 * @method TopicQuery leftJoinMessage($relationAlias = null) Adds a LEFT JOIN clause to the query using the Message relation
 * @method TopicQuery rightJoinMessage($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Message relation
 * @method TopicQuery innerJoinMessage($relationAlias = null) Adds a INNER JOIN clause to the query using the Message relation
 *
 ...
 *
 * @method Topic findOneByLabel(string $label) Return the first Topic filtered by the label column
 *
 * @method array findById(int $id) Return Topic objects filtered by the id column
 * @method array findByLabel(string $label) Return Topic objects filtered by the label column
 */
abstract class BaseTopicQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'Heri\\TicketBundle\\Model\\Topic';
        }
    ...
    {
        $sql = 'SELECT `id`, `label` FROM `topic` WHERE `id` = :p0';
        try {
    ...
    public function filterByLabel($label = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(TopicPeer::LABEL, $label, $comparison);
    }
    ...
    public function filterByMessage($message, $comparison = null)
    {
        if ($message instanceof Message) {
            return $this
                ->addUsingAlias(TopicPeer::ID, $message->getMessageId(), $comparison);
