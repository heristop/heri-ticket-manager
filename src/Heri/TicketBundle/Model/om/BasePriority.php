...
abstract class BasePriority extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Heri\\TicketBundle\\Model\\PriorityPeer';
     ...
     * @return Priority The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PriorityPeer::ID;
        }
    ...
    public function setLabel($v)
    {
        ...
        if ($this->label !== $v) {
            $this->label = $v;
            $this->modifiedColumns[] = PriorityPeer::LABEL;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = PriorityPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Priority object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PriorityPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PriorityQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PriorityPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PriorityPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(PriorityPeer::LABEL)) {
            $modifiedColumns[':p' . $index++]  = '`label`';
        }

        $sql = sprintf(
            'INSERT INTO `priority` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PriorityPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PriorityPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Priority'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Priority'][$this->getPrimaryKey()] = true;
        $keys = PriorityPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PriorityPeer::ID)) $criteria->add(PriorityPeer::ID, $this->id);
        if ($this->isColumnModified(PriorityPeer::LABEL)) $criteria->add(PriorityPeer::LABEL, $this->label);
    ...
    {
        $criteria = new Criteria(PriorityPeer::DATABASE_NAME);
        $criteria->add(PriorityPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Priority (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Priority Clone of current object.
     * @throws PropelException
     */
     ...
     * If this Priority is new, it will return
    ...
    public function setMessages(PropelCollection $messages, PropelPDO $con = null)
    {
        ...
        foreach ($messagesToDelete as $messageRemoved) {
            $messageRemoved->setPriority(null);
        }
     ...
     * Otherwise if this Priority is new, it will return
     * an empty collection; or if this Priority has previously
     * been saved, it will retrieve related Messages from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Priority.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|Message[] List of Message objects
     */
    public function getMessagesJoinUser($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = MessageQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(PriorityPeer::DEFAULT_STRING_FORMAT);
    }
