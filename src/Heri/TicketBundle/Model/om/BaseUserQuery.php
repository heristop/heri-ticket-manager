 ...
 *
 * @method UserQuery leftJoinResponse($relationAlias = null) Adds a LEFT JOIN clause to the query using the Response relation
 * @method UserQuery rightJoinResponse($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Response relation
 * @method UserQuery innerJoinResponse($relationAlias = null) Adds a INNER JOIN clause to the query using the Response relation
 *
...
abstract class BaseUserQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'Heri\\TicketBundle\\Model\\User';
        }
    ...
    {
        $sql = 'SELECT `id`, `username`, `firstname`, `lastname`, `fullname`, `email`, `enabled`, `salt`, `password`, `last_login`, `locked`, `expired`, `expires_at`, `roles` FROM `user` WHERE `id` = :p0';
        try {
    ...
    public function filterByMessage($message, $comparison = null)
    {
        if ($message instanceof Message) {
            return $this
                ->addUsingAlias(UserPeer::ID, $message->getAssignedUserId(), $comparison);
    ...
    public function filterByResponse($response, $comparison = null)
    {
        if ($response instanceof Response) {
            return $this
                ->addUsingAlias(UserPeer::ID, $response->getUserId(), $comparison);
