...
abstract class BaseResponse extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Heri\\TicketBundle\\Model\\ResponsePeer';
    ...
    public function setMessageId($v)
    {
        ...
        if ($this->message_id !== $v) {
            $this->message_id = $v;
            $this->modifiedColumns[] = ResponsePeer::MESSAGE_ID;
        }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[] = ResponsePeer::USER_ID;
        }
    ...
    public function setBody($v)
    {
        ...
        if ($this->body !== $v) {
            $this->body = $v;
            $this->modifiedColumns[] = ResponsePeer::BODY;
        }
    ...
    public function setIpAddress($v)
    {
        ...
        if ($this->ip_address !== $v) {
            $this->ip_address = $v;
            $this->modifiedColumns[] = ResponsePeer::IP_ADDRESS;
        }
    ...
    public function setCreationDate($v)
    {
        ...
        if ($this->creation_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ResponsePeer::CREATION_DATE;
            }
    ...
    public function setModificationDate($v)
    {
        ...
        if ($this->modification_date !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ResponsePeer::MODIFICATION_DATE;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->ip_address = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->creation_date = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            $this->modification_date = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
            $this->resetModified();
            ...
            return $startcol + 7; // 7 = ResponsePeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ResponsePeer::MESSAGE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`message_id`';
        }
        if ($this->isColumnModified(ResponsePeer::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`user_id`';
        }
        if ($this->isColumnModified(ResponsePeer::BODY)) {
            $modifiedColumns[':p' . $index++]  = '`body`';
        }
        if ($this->isColumnModified(ResponsePeer::IP_ADDRESS)) {
            $modifiedColumns[':p' . $index++]  = '`ip_address`';
        }
        if ($this->isColumnModified(ResponsePeer::CREATION_DATE)) {
            $modifiedColumns[':p' . $index++]  = '`creation_date`';
        }
        if ($this->isColumnModified(ResponsePeer::MODIFICATION_DATE)) {
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[6], $arr)) $this->setModificationDate($arr[$keys[6]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ResponsePeer::MESSAGE_ID)) $criteria->add(ResponsePeer::MESSAGE_ID, $this->message_id);
        if ($this->isColumnModified(ResponsePeer::USER_ID)) $criteria->add(ResponsePeer::USER_ID, $this->user_id);
        if ($this->isColumnModified(ResponsePeer::BODY)) $criteria->add(ResponsePeer::BODY, $this->body);
        if ($this->isColumnModified(ResponsePeer::IP_ADDRESS)) $criteria->add(ResponsePeer::IP_ADDRESS, $this->ip_address);
        if ($this->isColumnModified(ResponsePeer::CREATION_DATE)) $criteria->add(ResponsePeer::CREATION_DATE, $this->creation_date);
        if ($this->isColumnModified(ResponsePeer::MODIFICATION_DATE)) $criteria->add(ResponsePeer::MODIFICATION_DATE, $this->modification_date);
    ...
    public function getMessage(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aMessage === null && ($this->message_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aMessage->addResponses($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(ResponsePeer::DEFAULT_STRING_FORMAT);
    }
