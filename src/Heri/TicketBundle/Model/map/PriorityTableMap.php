...
class PriorityTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.Heri.TicketBundle.Model.map.PriorityTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('Heri\\TicketBundle\\Model\\Priority');
    ...
    {
        $this->addRelation('Message', 'Heri\\TicketBundle\\Model\\Message', RelationMap::ONE_TO_MANY, array('id' => 'priority_id', ), null, null, 'Messages');
    } // buildRelations()
